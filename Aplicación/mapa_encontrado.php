	...
	<body class="subpage">
		...
		<section id="one" class="wrapper style2">
			<div class="inner">
				...
				<section>
					<div align="center">						
						<form method="post" action="match_encontrado.php" enctype="multipart/form-data">					
							<input type="hidden" id="coords.lat" name="latitude"/>
							<input type="hidden" id="coords.lng" name="longitude"/>
							<a href="encontrado.php" class="button def" style='width:140px; height:42px'><center>Cancelar</center></a>
