			...
			<div class="inner">
				<section>
					<div class="inner">
						...
						<div align="left">
							<h2>Reportar objeto encontrado <i class="icon small fa-compass" style="font-size:30px"></i></h2>								
						</div>
						
						<form method="post" id="demoForm" action="mapa_encontrado.php" enctype="multipart/form-data">
						<div class="grid-style">							
							...
							<div>
								<b style="color:MediumSeaGreen">
									Fecha de cuando se encontró el objeto:<br>									
