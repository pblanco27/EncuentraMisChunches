<?php 
	...
	if ($_SERVER["REQUEST_METHOD"] == 'POST') {
		...
		$matchEncontrado = "CALL matchEncontrado($id_color, $id_zona, $id_tipo)";
		...
		if ($resultado == ""){			
			$registrarObjeto = "CALL newObject($id_color, $id_zona, $id_tipo, $id_usuario, '$descripcion', 0, 1, $latitud, $longitud, '$imagen', '$fecha')";			
			$mysqli->query($registrarObjeto); 		
			$_SESSION["mostrarMensaje"] = true;
			//echo $registrarObjeto;
