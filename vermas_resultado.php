	...
	<body class="subpage">
		...
		<section id="one" class="wrapper style2">
			<div class="inner">
							...
							<tbody>
								<?php
									if ($_SERVER["REQUEST_METHOD"] == 'POST') {
										...
										$id_user_report = $_POST["id_user_report"];
										$_SESSION["id_user_report"] = $_POST["id_user_report"];
								...
								<tr>
									...
									<?php 										
										if(!empty($imagen)){	
											...
											echo "<td>El usuario no adjuntó imagen al objeto.</td>";
										}
									?>
								</tr>
								<tr>
				...
				<div align="center">
					<a href="verobj.php" class="button def">Volver</a>
					<?php 
						if ($_SESSION["perdido"]){
							echo "<a href='registrarMatch.php' class='button def'>Es mío</a>";
						} else {
							echo "<a href='registrarMatch.php' class='button def'>Lo encontré</a>";
						}						
					?>					
				</div>
			</div>
